  ...
  return (
    <>
      <section
        ...
        style={{ width: `${Math.max(100, galleryImages.length * 35)}vw` }}
        aria-label="Gallery"
      >
      ...
      <AnimatePresence>
        {lightboxIndex !== null && (
          ...
          >
            ...
            >
              <div
                className="w-[80vw] h-[80vh] bg-cover bg-center"
            ...
            {lightboxIndex > 0 && (
              <button
                className="absolute left-8 text-warm-cream/40 hover:text-warm-cream text-2xl transition-colors"
            ...
            {lightboxIndex < galleryImages.length - 1 && (
              <button
                className="absolute right-8 text-warm-cream/40 hover:text-warm-cream text-2xl transition-colors"
                onClick={(e) => { e.stopPropagation(); setLightboxIndex(lightboxIndex + 1); }}
            ...
            <button
              className="absolute top-8 right-8 text-warm-cream/40 hover:text-warm-cream text-sm uppercase tracking-[0.2em] transition-colors"
              onClick={() => setLightboxIndex(null)}
